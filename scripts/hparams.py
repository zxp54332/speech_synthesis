...
tts_duration = HParams(
    ...
    en_question=join(dirname(__file__), "en_questions_dnn.hed"),
    cn_question=join(dirname(__file__), "cn_questions_dnn.hed"),
    question_path=None,
    ...
    generator_noise_dim=200,
    generator_params={
        "in_dim": None,  # None will be set automatically
        "out_dim": None,
        "num_hidden": 6,
        "hidden_dim": 512,
        "bidirectional": True,
...
tts_acoustic = HParams(
    ...
    # Stream info
    # (mgc, lf0, vuv, bap)
    stream_sizes=[180, 3, 1, 3],  # output size
